...
rotateMatrix = importlib.import_module('rotate_matrix').rotateMatrix
...
class TestRotateMatrix(unittest.TestCase):
  @classmethod
  def setUpClass(cls):
    with open(dirName + '/rotate-matrix.fixture.json') as jsonData:
      cls.fixture = json.load(jsonData)

  def test(self):
    print 'Example Tests:'
    for testCase in self.fixture['exampleTests']:
      printTestCase(rotateMatrix, testCase, self.assertEqual)
