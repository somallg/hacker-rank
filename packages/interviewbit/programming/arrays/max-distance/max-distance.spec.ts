/**
 * Test specs for max-distance problem
 * Interviewbit - MaxDistance
 */

import { generateArray } from '@challenges/util';

import { maxDistance } from './max-distance';

describe('Interviewbit - MaxDistance', () => {
  describe('maxDistance', () => {
    describe('Example tests', () => {
      it('should return 2 for Example 1 input [3, 5, 4, 2]', () => {
    ...
    describe('Correctness tests', () => {
      it('should return 3 for Sample 1 input [1, 2, 3, 4]', () => {
        expect(maxDistance([1, 2, 3, 4])).toEqual(3);
      });

      it('should return 0 for Sample 2 input [4, 3, 2, 1]', () => {
        expect(maxDistance([4, 3, 2, 1])).toEqual(0);
      });
      ...
      it('should return 0 for Extreme 2 input [1]', () => {
        expect(maxDistance([1])).toEqual(0);
      });
    });

    describe('Performance tests', () => {
      it('should run for Medium 1 input of 100 items', () => {
        maxDistance(generateArray(100));
      });

      it('should run for Large 1 input of 10e3 items', () => {
        maxDistance(generateArray(10e3));
      });

      it('should run for Large 2 input of 50e3 items', () => {
        maxDistance(generateArray(50e3));
      });

      it('should run for Large 3 input of 100e3 items', () => {
        maxDistance(generateArray(100e3));
      });
    });
  });
});
