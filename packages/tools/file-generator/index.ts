import { SourceFileConfig, SourceFileConfigOptions, SourceFn } from './type';
...
function getSourceFileConfigList(
  ...
  } as SourceFileConfigOptions)[lang];
}
...
function generateSourceFiles(
  ...
  return getSourceFileConfigList(problem, lang).map(({ name, sourceFn }) => ({
    name,
