...
describe('Separate the Numbers', () => {
  describe('separateNumbers function', () => {
    ...
    it('should return YES when input is 99332720572758669933272057275867', () => {
      expect(separateNumbers('99332720572758669933272057275867')).toBe(
        'YES 9933272057275866'
      );
    });
    ...
    it('should return YES when input is 93178437594967159317843759496716', () => {
      expect(separateNumbers('93178437594967159317843759496716')).toBe(
        'YES 9317843759496715'
      );
    });
    ...
    it('should return NO when input is 22026106139335712202610613933572', () => {
      expect(separateNumbers('22026106139335712202610613933572')).toBe(
        'YES 2202610613933571'
      );
    });
    ...
    it('should return YES when input is 63862140762791746386214076279175', () => {
      expect(separateNumbers('63862140762791746386214076279175')).toBe(
        'YES 6386214076279174'
      );
    });
    ...
    it('should return YES when input is 8342840360736983428403607370', () => {
      expect(separateNumbers('8342840360736983428403607370')).toBe(
        'YES 83428403607369'
      );
    });
    ...
    it('should return YES when input is 51073756645096775107375664509678', () => {
      expect(separateNumbers('51073756645096775107375664509678')).toBe(
    ...
    it('should return YES when input is 96589218797811259658921879781126', () => {
      expect(separateNumbers('96589218797811259658921879781126')).toBe(
  ...
  describe('add', () => {
    ...
    it('should add 1 to 96589218797811259658921879781126', () => {
      expect(addOne('96589218797811259658921879781126')).toBe(
        '96589218797811259658921879781127'
      );
    });
  });
});
